...
output_base = source / "attack-bash-2h-halberd"
tracker_file = source / ".direction_tracker_attack.json"
    ...
    def organize_files(self):
        ...
        try:
            ...
            for i, file in enumerate(numbered_files):
                ...
                print(f"✅ {file.name} -> attack-bash-2h-halberd/{direction}/frame{i}.bmp")
...
print("=" * 60)
print("  AUTO-ORGANIZE WATCHER - ATTACK BASH 2H HALBERD")
print("=" * 60)
print()
